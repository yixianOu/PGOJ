...
func LoginWithCodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LoginWithCodeRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, xcode.InvalidParams.WithDetails(err.Error()))
			return
		}

		l := users_info.NewLoginWithCodeLogic(r.Context(), svcCtx)
		resp, err := l.LoginWithCode(&req)
		if err != nil {
